...
import com.fai.usuario.infrastructure.exeptions.ResourceNotFoundExcepton;
import com.fai.usuario.infrastructure.repository.UsuarioRepository;
import com.fai.usuario.infrastructure.security.JwtUtil;
...
public class UsuarioService {
    ...
    public UsuarioDTO atualizaDadosUsuario(String token, UsuarioDTO dto){
        //Aqui buscamos o email do usuário através do tpken (Tira a obrgatoriedade do email)
        ...
        Usuario usuarioEntity = usuarioRepository.findByEmail(email).orElseThrow(() ->
                new ResourceNotFoundExcepton("Email não localizado"));
